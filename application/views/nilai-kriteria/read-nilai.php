  ...
  <div class="card">
    <div class="card card-plain">
      <div class="content table-responsive table-full-width">
        ...
        <form class="" action="<?php echo base_url('welcome/showTabel'); ?>" method="post">
        ...
        //tabel kriteria
            ...
            foreach ($data_kriteria as $dk)://foreach ambil dari Controller (buat Kriteria A)
              ...
              ?>
              <tr hidden>
                <td><input type="text" name="C[<?php echo $ra.$jid; ?>]" value="C<?php echo $ra;?>"hidden><?php echo $dk->nama_kriteria;?></td>
                ...
                <!--buat input id--><td><input type="text" name="" value="<?php echo $ra.$jid; ?>"hidden></td>
              </tr>
            <?php
             }
            ...
            ?>
              <tr hidden>
                <td><input type="text" name="C[<?php echo $ra.$jid; ?>]" value="C<?php echo $ra; ?>"></td>
                <td><input id="W<?php echo $ra.$jid; ?>" name="W[<?php echo $ra.$jid; ?>]" type="text" value=""> </td>
                <td><input type="text" name="X[<?php echo $ra.$jid; ?>]" value="C<?php echo $jid; ?>"></td>
