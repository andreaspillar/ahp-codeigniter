  <div class="card">
    <div class="card card-plain">
      <div class="content table-responsive table-full-width">
        <form id="form" action="<?php // echo site_url('assessors/updNiQaKu'); ?>" method="post">
          <table class="table table-hover table-striped">
            ...
            <tr>
              <td colspan="2"><a class="btn btn-warning btn-fill" href="<?php echo site_url('assessors/index/'); ?>" onmouseover="demo.showBack('top','center');" name="button"><i class="pe-7s-back"></i>&nbsp&nbsp Kembali</a>
        ...
        <script type="text/javascript">
          $('#btn').click(function(event) {
           ...
           $.ajax({
             type: "POST",
             url: "<?php  echo site_url('assessors/updNiQaKu'); ?>",
             data: form,

             success: function(data){
               <?php foreach ($nilK as $a): ?>
               $('#clk').load("<?php echo site_url('assessors/dataKDJ/'.$a->jabatan); ?>");
               <?php endforeach; ?>
