          ...
          <?php if ($karyawan>0) {
            ...
            <tr>
              ...
              <?php } else{ ?>
                ...
                <td>
                  <a class="btn btn-block btn-fill btn-primary btUB" data-href="<?php echo site_url('assessors/rank_kb_new/'.$qar->id_karyawan); ?>" title="Nilai Karyawan" type="button" ><i class="pe-7s-graph1"></i> Nilai</a>
                </td>
              <?php } ?>
            </tr>
            ...
            <td>
              <a class="btn btn-info btn-fill btn-block btUB" data-href="<?php echo site_url('assessors/rank_kb_edit/'.$qar->id_karyawan) ?>" >Ubah</a>
            </td>
          </tr>
          <?php }
        }
