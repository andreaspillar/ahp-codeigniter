        ...
        <tbody>
          <?php if ($karyawan>0) {
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-block btn-fill btn-primary" href="<?php echo site_url('HR/rank/'.$qar->id_karyawan); ?>" title="Nilai Karyawan" type="button"><i class="pe-7s-graph1"></i> Nilai</a>
              </td>
            </tr>
          <?php }
        }
