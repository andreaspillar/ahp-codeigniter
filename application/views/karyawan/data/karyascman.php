          ...
          <?php if ($karyawan>0) {
            ...
            <tr>
              ...
              <?php } else{ ?>
                ...
                <td>
                  <a class="btn btn-block btn-fill btn-primary btUB" data-href="<?php echo site_url('HR/rankn/'.$qar->id_karyawan); ?>" title="Nilai Karyawan" type="button" ><i class="pe-7s-graph1"></i> Nilai</a>
                </td>
              <?php } ?>
            </tr>
